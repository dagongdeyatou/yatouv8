...
def finalize(chrome_path: pathlib.Path, yatou_path: pathlib.Path, output: pathlib.Path) -> dict[str, Any]:
...
def main() -> int:
    ...
    report = finalize(arguments.chrome, arguments.yatou, arguments.output)
